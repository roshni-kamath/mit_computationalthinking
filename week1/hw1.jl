...
function matrix_to_vecvec(x)
	# missing = zeros(0)
	# for i in 1:size(x, 1)
	# 	for j in 1:size(x, 2)
	# 		append!(missing, x[i,j])
	# 	end
	# end
	# return missing
...
begin
	...
	function noisify(color::AbstractRGB, s)
		# you will write me in a later exercise!
		return (color.r+s, color.g+s, color.b+s)
	end
